...
#include "\x\A3A\addons\core\Templates\Templates\3CB\3CB_Reb_Vehicle_Attributes.sqf"
...
"UK3CB_BHP_9_13Rnd", "rhs_mag_762x25_8", "rhs_grenade_mkii_mag", "rhs_grenade_mki_mag", "rhs_mag_rdg2_black", "rhs_grenade_m15_mag",
